 ...
 * 
 */
	// Get data for all arrivals

	const url = "http://localhost:8080/airport-monitor-server/arrivals/getAll"; 
	// Get data
	...
	source.onmessage = function(event) {
		...
		var current_tbody = document.getElementById("arrivalsInnerTbody"); 
		// create new tbody 
		var new_tbody = document.createElement('tbody');
		new_tbody.setAttribute("id", "arrivalsInnerTbody"); // adding id to the new tbody
